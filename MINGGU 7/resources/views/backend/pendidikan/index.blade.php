                        ...
                        <div class="modal fade" id="basicModal" tabindex="-1">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form id="pendidikan_form" method="POST" action="{{ route('pendidikan.store') }}">
                                        @csrf
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <select class="form-select" aria-label="Default select example"
                                                    name="tingkatan" id="tingkatan" required>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <select class="form-select"
                                                                aria-label="Default select example" name="tingkatan"
                                                                id="tingkatan" required>
                                                                <option
                                                                    value="1"{{ isset($item) && $item->tingkatan == 1 ? 'selected' : '' }}>
                                                                    TK</option>
                                                                <option
                                                                    value="2"{{ isset($item) && $item->tingkatan == 2 ? 'selected' : '' }}>
                                                                    SD</option>
                                                                <option
                                                                    value="3"{{ isset($item) && $item->tingkatan == 3 ? 'selected' : '' }}>
                                                                    SMP</option>
                                                                <option
                                                                    value="4"{{ isset($item) && $item->tingkatan == 4 ? 'selected' : '' }}>
                                                                    SMA/SMK</option>
                                                                <option
                                                                    value="5"{{ isset($item) && $item->tingkatan == 5 ? 'selected' : '' }}>
                                                                    D3</option>
                                                                <option
                                                                    value="6"{{ isset($item) && $item->tingkatan == 6 ? 'selected' : '' }}>
                                                                    D4/S1</option>
                                                                <option
                                                                    value="7"{{ isset($item) && $item->tingkatan == 7 ? 'selected' : '' }}>
                                                                    S2</option>
                                                                <option
                                                                    value="8"{{ isset($item) && $item->tingkatan == 8 ? 'selected' : '' }}>
                                                                    S3</option>
                                                            </select>
                                                        </div>
                                                        ...
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <input type="number" class="form-control"
                                                                name="tahun_keluar" id="tahun_keluar" min="1900"
                                                                max="{{ date('Y') }}"
